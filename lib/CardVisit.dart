      ...
      child:  new Column(
        children: <Widget>[
          new ListTile(
            ...
            title: new Text("Phạm Văn Mạnh", style:  new TextStyle(fontWeight: FontWeight.w400),),
          ...
          new ListTile(
            ...
            title: new Text("manhkiooo@gmail.com", style: new TextStyle(fontWeight: FontWeight.w400),),
          ),
          new ListTile(
            leading: new Icon(Icons.phone, color: Colors.blue, size: 26.0,),
            title: new Text("+84 965 436 225", style: new TextStyle(fontWeight: FontWeight.w400),),
          )
        ],
      ),
    );
